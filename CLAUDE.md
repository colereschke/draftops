...
- #10 Budget-for-picks trading — done (see "What's Built" above and `docs/superpowers/specs/2026-07-28-budget-for-picks-trading-design.md`). Was previously an open design decision (ledger vs. first-class assets, coupled to #8's dynamic pick valuation); resolved as a first-class `Trade` ledger with pick-holder resolution wired into both budget legality and pick valuation.
